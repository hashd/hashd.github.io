...
description: "Why some recursion is cheap and some isn't — with a detour through the BEAM."
date: 2015-07-26
...
{% highlight c %}
printf("%d\n", factorial(5))
-> return 5 _ factorial(4) :: factorial(5) returns to main function
-> return 4 _ factorial(3) :: factorial(4) returns to factorial(5) instance in the call stack
-> return 3 _ factorial(2) :: factorial(3) returns to factorial(4) instance in the call stack
-> return 2 _ factorial(1)
-> return 1
{% endhighlight %}
